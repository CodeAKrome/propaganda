...
class BiasValidator:
    ...
    def parse_stored_bias(self, bias_str: str) -> Optional[dict]:
        """
    ...
    def detect_bias(self, text: str) -> Optional[dict]:
        """
    ...
    def validate(self, sample_size: int = 10, output_file: Optional[str] = None):
        """
