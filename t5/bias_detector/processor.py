...
class BiasProcessor:
    ...
    def __init__(self, api_url: str = "http://localhost:8000", output_file: Optional[str] = None):
        """
    ...
    def process_articles(self, batch_size: Optional[int] = None, dry_run: bool = False, max_failures: int = 3):
        """
