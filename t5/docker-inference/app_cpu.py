...
app = FastAPI(
    title="Bias Detector API (CPU/CUDA)",
    description="Political bias detection using T5 with LoRA adapters",
    version="1.0.0",
    lifespan=lifespan
)
...
async def root():
    ...
    return {"status": "healthy", "version": "1.0.0", "mode": "CPU/CUDA"}
...
async def predict(request: PredictRequest):
    ...
    try:
        ...
        instance = get_model(request.model_path, request.base_model_name)
