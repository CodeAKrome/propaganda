#./batch.sh  "Analize actions and motivations."
#./batch.sh propalestine "Summarize news about pro Palestinian protests. Analize actions and motivations."
#./batch.sh mahmoud "Summarize all events involving Mahmoud Khalil. Analize actions and motivations."
#./allbatch.sh soros "Summarize all actions taken by George Soros. Analize actions and motivations."
#./batch.sh cbdcviet "Summarize CBDC central bank digital currency legislation and implementation in Viet Nam. Analize actions and motivations."
